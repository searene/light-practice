...
const 正しい状態 = {
    ロービーム: [lightSwitch.lowBeam, ヘッドライトレバー.ロービーム, ハザードランプ.オフ],
    ハイビーム: [lightSwitch.lowBeam, ヘッドライトレバー.ハイビーム, ハザードランプ.オフ],
    ハイビームとロービームの切り替え: [lightSwitch.lowBeam, ヘッドライトレバー.ハイビームとロービームの切り替え, ハザードランプ.オフ],
