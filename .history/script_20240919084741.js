...
const 正しい状態 = {
    ロービーム: [lightSwitch.lowBeam, headlightLever.lowBeam, ハザードランプ.オフ],
    ハイビーム: [lightSwitch.lowBeam, headlightLever.highBeam, ハザードランプ.オフ],
    ハイビームとロービームの切り替え: [lightSwitch.lowBeam, headlightLever.highLowBeamToggle, ハザードランプ.オフ],
    ハザードランプ: [lightSwitch.positionLight, headlightLever.lowBeam, ハザードランプ.オン],
}
const selectedStatus = [lightSwitch.closed, headlightLever.lowBeam, ハザードランプ.オフ]
const sounds = [
